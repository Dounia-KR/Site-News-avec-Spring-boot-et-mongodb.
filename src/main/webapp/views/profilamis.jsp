  ...
  <div class="info">
           ...
           <c:forEach items="${newsAll}" var="n">
                ...
                <div id="formulaire" class="article1">
                      <form:form  modelAttribute="comment" method="POST" action="${pageContext.servletContext.contextPath}/savecomment/${n.id}/${login}/profilamis">
                    ...
                    <a style="margin-right: 5px;" href="${pageContext.servletContext.contextPath}/savereaction/1/${n.id}/${login}/profilamis">
                    <img class="profilee" src="/img/like.png" /></a>
                    <a href="${pageContext.servletContext.contextPath}/savereaction/-1/${n.id}/${login}/profilamis">
